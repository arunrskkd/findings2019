      ...
      <div class="aboutpage-container">
          <section id="section-1" data-page="sectionone" class="section">
            <div class="section-left">
                <h2>automation</h2>
                <h3><b>T</b>here are an ever-increasing number of ways to solve the challenges of Market Research.  Market Cube is uniquely positioned to consult on the best path forward with our strong knowledge of the toolsets available and their best uses, such as applying deep learning to each panelist to create next generation insights.</h3>
            ...
            <video src="<?php bloginfo('template_directory'); ?>/videos/v2.mp4" muted preload="auto" loop autoplay poster="<?php bloginfo('template_directory'); ?>/images/v2.jpg"></video>
            </div>
            <div class="sect-foot">
                <div class="foot-left">
                  <div class="number">
                ...
                <div class="foot-rit">
                    <a href="http://localhost/projects/marketcube/people/" class="nextpage">
