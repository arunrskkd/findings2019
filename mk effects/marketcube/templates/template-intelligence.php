  ...
  <main id="barba-wrapper">
      ...
      <div class="aboutpage-container">
          <section id="section-1" data-page="sectionone" class="section">
            ...
            <video src="<?php bloginfo('template_directory'); ?>/videos/v3.mp4" muted="" preload="auto" loop="" autoplay poster="<?php bloginfo('template_directory'); ?>/images/v3.jpg"></video>
            </div>
            <div class="sect-foot">
                <div class="foot-left">
                  <div class="number">
                ...
                <div class="foot-rit">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>automation/" class="nextpage">
