...
namespace Acodez\Faq\Controller\Adminhtml\Faq;
...
class Edit extends Action
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                $model = $this->_objectManager->create('Acodez\Faq\Model\Faq')->load($id);
            ...
            $model = $this->_objectManager->create('Acodez\Faq\Model\Faq');
        }
        ...
        $resultPage->setActiveMenu('Acodez_Faq::faq_item');
